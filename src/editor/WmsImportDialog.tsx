  ...
  const generate = async () => {
    ...
    try {
      ...
      if (recFile) {
        ...
        notes.push('Файл рекомендаций не приложен — доли брака/кросс-дока/нонсорта оставлены по умолчанию.', '');
      }
        ...
        {!summary && (
          <>
            <p className="hint-text">
              ...
              необязательный файл, из него читаются только три доли: брак, кросс-док и грубая оценка
              нонсорта (подробнее — во всплывающих подсказках самого сценария после генерации).
            </p>
